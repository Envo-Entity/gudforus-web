...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      "https://gudforus.com/blog/why-ingredient-lists-are-hard-to-understand",
  },
  openGraph: {
    title: "Why Ingredient Lists Are So Hard to Understand — Gud For Us",
    description:
    ...
    url: "https://gudforus.com/blog/why-ingredient-lists-are-hard-to-understand",
    type: "article",
...
export default function Page() {
  const html = readFileSync(
    join(process.cwd(), 'app/blog/why-ingredient-lists-are-hard-to-understand/why-ingredient-lists-are-hard-to-understand.html'),
    'utf-8'
  )
