        ...
        <section className="relative overflow-hidden px-6 pb-20 pt-[140px] text-center">
          ...
          <div className="relative mx-auto max-w-[780px]">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-3.5">
              ...
              >
                <AppleStoreIcon className="h-[18px] w-[18px] shrink-0" />
                Download for iOS
              </a>
              <Link
                href="/blog"
        ...
        <section className="relative overflow-hidden bg-[#2d6a4f] px-6 py-[72px] text-center">
          ...
          <div className="relative mx-auto max-w-[600px]">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              ...
              >
                <span className="inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#2d6a4f]">
                  <AppleStoreIcon className="h-[14px] w-[14px] shrink-0" />
                </span>
                Try for iOS
              </a>
              <a
